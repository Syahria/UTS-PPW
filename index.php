  ...
  <div class="container p-5">
    <div class="d-flex justify-content-center">
      <div class="card" style="width: 30rem;">
        <img src="Librarylogo.png" class="card-img-top" alt="logo">
        <hr>
      ...
      <div class="card-body pt-2">
        ...
        <div class="row gap-2 p-2">
          <a class="btn btn-secondary" href="sign_in_admin.php">Admin</a>
          <a class="btn btn-secondary" href="sign_in_petugas.php">Petugas</a>
          <a class="btn btn-primary mb-2" href="sign_in_member.php">Siswa</a>
          <hr>
