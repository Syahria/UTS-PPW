...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar fixed-top bg-body-tertiary shadow-sm">
      <div class="container-fluid p-3">
        ...
        <ul style="margin-left: -7rem;" class="dropdown-menu position-absolute mt-2 p-2">
          ...
          <li>
            <a class="dropdown-item text-center text-secondary" href="#"> <span class="text-capitalize"><?php echo $_SESSION['petugas']['nama_petugas']; ?></a>
            </span>
          </li>
          <hr>
          <li>
          ...
          <li>
            <a class="dropdown-item text-center p-2 bg-danger text-light rounded" href="signOutpetugas.php">Sign Out <i class="fa-solid fa-right-to-bracket"></i></a>
          </li>
          </ul>
        </div>
      </div>
    ...
    <div class="mt-5 p-4">
      ...
      <div class="alert alert-success" role="alert">Selamat datang Petugas - <span class="fw-bold text-capitalize"><?php echo $_SESSION['petugas']['nama_petugas']; ?></span> di Dashboard</div>
      ...
      <div class="mt-4 p-3">
        ...
        <div class="cardImg">
          <a href="dashboardAdmin/member/member.php">
